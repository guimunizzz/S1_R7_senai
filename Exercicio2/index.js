...
if (genero != "M" && genero != "H") { //Verificação se digitou o genero da forma correta
  ...
  let novoSalario;
  if (isNaN(salarioAtual && qntdAnos)) { // Verificação se foi digitado um numero nas variaveis salario e anos
